...
public class WebKeyword {
     ...
     *
     * @param locator
     * @return list elements to be located
     */
    ...
    /**
     * Keyword for click on element using javascript
     * @param webElement: element to click
     */
