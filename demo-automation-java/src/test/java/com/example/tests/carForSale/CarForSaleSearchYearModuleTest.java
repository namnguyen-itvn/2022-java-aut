...
public class CarForSaleSearchYearModuleTest extends BaseTest{
    ...
    @Test(testName = "Verify That The Year Selected Should Be Displayed In The Title Of Car On Vehicle Details Page When User Click On Car Item", dataProvider = "yearDataForTest", dataProviderClass = CarForSaleTestData.class)
    public void verifyThatTheYearSelectedShouldBeDisplayedInTheTitleOfCarOnVehicleDetailsPageWhenUserClickOnCarItem(String year){
        BasePage basePage = new BasePage(driver);
        basePage.navigateToPage("Sale");
        CarForSaleSearchYearModulePage carForSaleSearchYearModulePage = new CarForSaleSearchYearModulePage(driver);
