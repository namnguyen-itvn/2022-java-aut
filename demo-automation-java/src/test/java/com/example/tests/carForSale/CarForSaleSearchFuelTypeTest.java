...
import com.example.pages.carForSale.CarForSaleSearchFuelTypePage;
import com.example.tests.BaseTest;

@Listeners(ReportListener.class)
public class CarForSaleSearchFuelTypeTest extends BaseTest{
    ...
    public void verifyThatFuleTypeFilterDisplayCorrectlyAsRequirement(){
        ...
        CarForSaleSearchFuelTypePage carForSaleFuelTepyPage = new CarForSaleSearchFuelTypePage(driver);
